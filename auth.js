...
var options = {
    uri: 'https://oauth.vk.com/authorize?client_id=YOUR_APP_ID&scope=wall,messages,photos&redirect_uri=http%3A%2F%2Fapi.vk.com%2Fblank.html&display=touch&response_type=token',
    method: 'GET',
    headers: {
